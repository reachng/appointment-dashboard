...
appointment = pd.read_csv(
    r'/home/webapp/zip_codes/zip/management/commands/appointment_list.csv',
    low_memory=False
)
STATUS_MAPPING = {
    'N': 'Not Assigned',
...
# Load user data
user = pd.read_csv(
    r'/home/webapp/zip_codes/zip/management/commands/user.csv',
    low_memory=False
)
...
# Load address data
address = pd.read_csv(
    r'/home/webapp/zip_codes/zip/management/commands/address.csv',
    low_memory=False
)
...
<html lang="en">
    <head>
        ...
        <style>
           ...
           button#export-table-g-id-complaints,button#export-table-g-id-summary,button#export-table-user-state-count {
           ...
           button#export-table-g-id-complaints,button#export-table-g-id-summary,button#export-table-user-state-count:hover,
           button#export-table-g-id-complaints,button#export-table-g-id-summary,button#export-table-user-state-count:focus {
           ...
           button#export-table-g-id-complaints,button#export-table-g-id-summary,button#export-table-user-state-count:active {
...
address_mapped = pd.read_csv(r'/home/webapp/zip_codes/zip/management/commands/address_mapped.csv', low_memory=False)
...
users = pd.read_csv('/home/webapp/zip_codes/zip/management/commands/user.csv', low_memory=False)
appointments = pd.read_csv('/home/webapp/zip_codes/zip/management/commands/appointment_list.csv', low_memory=False)
